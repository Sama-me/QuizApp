...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            ...
            } else if (!questionFourAnswer2 && !questionFourAnswer3) {
                grade4 = 0;
                question4TextView.setTextColor(incorrectAnswerColor);
                question4TextView.setBackgroundColor(incorrectAnswerColorBack);
            } else if (questionFourAnswer2 && questionFourAnswer3 && questionFourAnswer1) {
                grade4 = 20;
                question4TextView.setTextColor(incorrectAnswerColor);
                question4TextView.setBackgroundColor(incorrectAnswerColorBack);
            } else {
